...
const SearchBox = () => {
  ...
  const categoryDropdown = <Menu direction="left" handler={<DropDownHandler alignItems="center" bgcolor="#AFD0E7" height="100%" px={3} color="grey.700" component={TouchRipple}>
