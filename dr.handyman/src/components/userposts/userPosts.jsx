...
//   }
	...
	const handleChange = (event, value) => {
		getPostPage({ variables: { page: value - 1, postPerPage: 6 } });
		console.log(page);
		setPage(value);
	};
	...
	return (
        ...
        {type === 'accept' ? (	<H5 color="grey.600" my="0px" mx={0.75} textAlign="left">
					Posted By
				</H5>) : 	<H5 color="grey.600" my="0px" mx={0.75} textAlign="left">
					User Accept
				</H5>}
